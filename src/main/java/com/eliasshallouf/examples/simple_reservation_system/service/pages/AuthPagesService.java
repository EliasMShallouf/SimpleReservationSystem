...
import com.eliasshallouf.examples.simple_reservation_system.domain.model.exceptions.ExceptionResponse;
...
import com.eliasshallouf.examples.simple_reservation_system.domain.model.request.RegisterModel;
...
public class AuthPagesService {
    ...
    public String registerFormSubmit(
        ...
        try {
            User user = new User();
            user.setGithubEmail(registerModel.getEmail());
